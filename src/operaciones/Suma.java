 ...
 *  
 * @author Jorge Jaen Ferrer // Diego Paul Llive //Jose Maria Tenreiro
 * @since 23/02/2021
 *
 */
public class Suma {
     ...
     * 
     */
	public double suma_Real(double num1, double num2)  {
		sumaR=num1+num2;
		return sumaR;
	}
     ...
     *
     */
	public int suma_Dos_Entero(int num1, int num2)  {
		sumaE=num1+num2;
		return sumaE;
	}
     ...
     *
     */
	public double suma_Tres_Real(double num1, double num2, double num3)  {
		sumaR2=num1+num2+num3;
		return sumaR2;
	}
